...
#
#
plot_spatial_clusters = function(coords=NULL, cluster_df=NULL, ks='dtc', ws=NULL, deepSplit=NULL, plot_meta=NULL, color_pal=NULL, ptsize=NULL, txsize=NULL){
  ...
  for(metacol in plot_meta){
    ...
    if(!is.numeric(df_tmp[['meta']])){ # Test if it's not numeric and make legend spots/dots larger
      p = p +
