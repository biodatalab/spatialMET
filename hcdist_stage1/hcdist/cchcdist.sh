...
# debug
#gcc -pthread -Wall -Wno-unused-but-set-variable -fno-diagnostics-show-caret -fno-diagnostics-show-option -mfpmath=sse -mavx2 -O2 -g -funroll-loops -fomit-frame-pointer -momit-leaf-frame-pointer -fno-math-errno -fno-signed-zeros -fno-trapping-math -fno-signaling-nans hcdist.c tree.c text.c rand_xoshiro256.c -o hcdist_test -lm |& grep -v "In function "

# for profiling with gprof
#gcc -pthread -Wall -Wno-unused-but-set-variable -fno-diagnostics-show-caret -fno-diagnostics-show-option -mfpmath=sse -mavx2 -O2 -g -pg -funroll-loops -fomit-frame-pointer -momit-leaf-frame-pointer -fno-math-errno -fno-signed-zeros -fno-trapping-math -fno-signaling-nans hcdist.c tree.c text.c rand_xoshiro256.c -o hcdist_test -lm |& grep -v "In function "
